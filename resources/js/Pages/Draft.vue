    ...
    <div class="col-span-10 bg-gray-100 pt-[50px] pl-[50px] pr-[50px]">
      <div>
        ...
        <div class="my-[45px]">
            ...
            <div class="flex mr-[10px] w-full">
              ...
              <div class="w-full flex justify-between">
                <div class="flex items-center">
                  <h1 class="text-[20px] font-semibold">Monthly Quiz Draft</h1>
                </div>
                <div class="flex">
                  <div
                    class="
                    ...
                    "
                  >
                    <h1 class="text-white">Delete Selected</h1>
                  </div>
                  <div
                    class="
                      bg-[#3550DC]
                    ...
                    "
                  >
                    <h1 class="text-white">Publish Quiz</h1>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="flex justify-end mb-[10px] mt-[5px]">
            <div
              class="
                flex justify-center
                bg-theme-color
            ...
            <div
              ...
              "
            >
              <h1 class="text-[#AFAFAF]">Chemistry</h1>
            </div>
            <div
              class="
                flex justify-center
              ...
              "
            >
              <h1 class="text-[#AFAFAF]">biology</h1>
            </div>
          </div>

          <div class="grid gap-[10px]">
            <div class="grid grid-cols-12 p-[10px]">
              <div class="flex items-center">
            ...
            <div class="grid grid-cols-12 bg-white rounded-[8px] p-[10px]">
              <div class="flex items-center">
                <div class="border-2 border-black w-[12px] h-[12px]"></div>
              </div>
              <div>
              ...
              <div class="col-span-5">
                <h1 class="">Quam amet, vulputate nisl varius eleifend.</h1>
              </div>
              <div>
                <h1 class="">Sed</h1>
              </div>
              ...
              <div class="flex justify-end text-[#3550DC]">
                <Menu as="div" class="relative inline-block text-left">
                  <div>
                    <MenuButton class="flex justify-end text-[#3550DC]">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        fill="currentColor"
