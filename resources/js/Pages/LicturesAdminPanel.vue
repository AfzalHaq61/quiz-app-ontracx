        ...
        <div class="my-[45px]">
          <div class="flex justify-between mb-[20px]">
            <div class="flex mr-[10px]">
              ...
              <div>
                <h1 class="text-[20px] font-semibold">Boilogy Videos</h1>
              </div>
            </div>
          ...
          <div class="grid gap-[10px]">
            <div class="grid grid-cols-8 p-[10px]">
              ...
              <div>
                <h1 class="text-[#AFAFAF]">Status</h1>
              </div>
            ...
            <div class="grid grid-cols-8 bg-white rounded-[8px] p-[10px]">
              <div class="flex items-center">
                <div class="border-2 border-black w-[12px] h-[12px]"></div>
              </div>
              <div class="">
                <img src="images/blogimage.png" alt="">pic
              </div>
              <div class="col-span-2">
                <h1 class="">Amet eu enim.</h1>
              </div>
              <div class="col-span-2">
                <h1>Amet eu amet.</h1>
              </div>
