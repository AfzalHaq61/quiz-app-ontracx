        ...
        <div class="my-[45px]">
          ...
          <div class="grid gap-[10px]">
            ...
            >
              ...
              <div>
                <h1 class="truncate w-[110px] mr-5">{{ mcq.answer_one }}</h1>
              </div>
              <div>
                <h1 class="truncate w-[110px] mr-5">{{ mcq.answer_two }}</h1>
              </div>
              <div>
                <h1 class="truncate w-[110px] mr-5">{{ mcq.answer_three }}</h1>
              </div>
              <div>
                <h1 class="truncate w-[110px] mr-5">{{ mcq.answer_four }}</h1>
              </div>
